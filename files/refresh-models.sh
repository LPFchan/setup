...
PROFILES_SOURCE="${REFRESH_MODELS_PROFILES_SOURCE:-$SOURCE_BASE/files/claudex-profiles.json}"
...
_stage_assets() {
    ...
    _fetch_file "$PROFILES_SOURCE" "$directory/claudex-profiles.json" || return 1
