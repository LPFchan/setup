...
`LPFchan/setup`. This document tells agents how to use that system; it is not
a second source of truth for the implementation.

## Live-service adoption

Use this guide when adding, changing, reviewing, testing, deploying, or
operating a lost.plus service behind Common Auth.
