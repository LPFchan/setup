...
| `mac-boot` | Fleet-only macOS boot-volume switcher for `Audio Work` and `The Rest`, with passwordless switching through a narrowly scoped sudo rule | `files/mac-boot.sh` |
