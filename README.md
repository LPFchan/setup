...
| `opencodex` | `~/.local/bin/opencodex` provider/harness launcher + pinned OpenCodex runtime and service + managed providers in `~/.opencodex/config.json` | — | `files/opencodex.sh` |
