...
| `harnesses` | AI harness install/update, settings, and MCP enrollment; operated lost.plus credentials come from `auth`, while external-service credentials remain in the passage MCP (`~/.local/bin/harnesses`) | `files/harnesses.sh` |
